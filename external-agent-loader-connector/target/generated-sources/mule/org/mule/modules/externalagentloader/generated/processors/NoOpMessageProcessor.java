...
package org.mule.modules.externalagentloader.generated.processors;
...
/**
 * NoOpMessageProcessor invokes the {@link org.mule.modules.externalagentloader.ExternalAgentLoaderConnector#noOp()} method in {@link ExternalAgentLoaderConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public NoOpMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((ExternalAgentLoaderConnector) object).noOp();
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at ExternalAgentLoaderConnector at noOp retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
